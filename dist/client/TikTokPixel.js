...
export function TikTokPixel() {
    ...
    return (_jsx(Script, { id: "tiktok-pixel", strategy: "afterInteractive", onLoad: () => logPixelEvent("TikTok script loaded successfully"), onError: (e) => logPixelError("TikTok script failed to load", e), dangerouslySetInnerHTML: {
            __html: `
          !function (w, d, t) {
